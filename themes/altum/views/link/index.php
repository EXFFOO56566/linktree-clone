        ...
        <div class="col-auto">
            <div class="d-flex align-items-center">
                ...
                <?php if($data->method != 'statistics'): ?>
                    <a href="<?= url('link/' . $data->link->link_id . '/statistics') ?>" class="btn btn-link text-secondary" data-toggle="tooltip" title="<?= l('link.statistics.link') ?>"><i class="fa fa-fw fa-sm fa-chart-bar"></i></a>
                <?php endif ?>

                <?php if($data->method != 'settings'): ?>
                    <a href="<?= url('link/' . $data->link->link_id . '/settings') ?>" class="btn btn-link text-secondary" data-toggle="tooltip" title="<?= l('global.edit') ?>"><i class="fa fa-fw fa-pencil-alt"></i></a>
                <?php endif ?>
