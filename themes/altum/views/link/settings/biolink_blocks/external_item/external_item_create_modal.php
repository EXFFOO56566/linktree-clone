            ...
            <div class="modal-body">
                <form name="create_biolink_external_item" method="post" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <input id="external_item_location_url" type="text" class="form-control" name="location_url" maxlength="2048" placeholder="<?= l('create_biolink_link_modal.input.location_url_placeholder') ?>" />
                    </div>
