...
<div class="card">
    <div class="card-body">
        ...
        <form name="update_vcard" action="" method="post" role="form">
            ...
            <div class="form-group">
                <label for="<?= 'vcard_email_' . $data->link->link_id ?>"><i class="fa fa-fw fa-envelope fa-sm text-muted mr-1"></i> <?= l('global.email') ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'vcard_city_' . $data->link->link_id ?>"><i class="fa fa-fw fa-city fa-sm text-muted mr-1"></i> <?= l('global.city') ?></label>
            ...
            <div class="form-group">
                <label for="<?= 'vcard_country_' . $data->link->link_id ?>"><i class="fa fa-fw fa-globe fa-sm text-muted mr-1"></i> <?= l('global.country') ?></label>
