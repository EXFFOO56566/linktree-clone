                    ...
                    <form action="" method="get" role="form">
                        ...
                        <div class="form-group px-4">
                            ...
                            <select name="type" id="filters_type" class="custom-select custom-select-sm">
                                ...
                                <?php foreach($data->ai_text_types as $key => $value): ?>
    ...
    <table class="table table-custom">
        ...
        <?php foreach($data->documents as $row): ?>
            ...
            <tr>
                ...
                <td class="text-nowrap">
                    <span class="px-2 py-1 rounded small font-weight-bold" style="background: <?= $data->ai_text_categories[$data->ai_text_types[$row->type]['category']]['background_color'] ?>; color: <?= $data->ai_text_categories[$data->ai_text_types[$row->type]['category']]['color'] ?>;">
                        <i class="<?= $data->ai_text_types[$row->type]['icon'] ?> fa-fw fa-sm mr-1"></i> <?= l('documents.type.' . $row->type) ?>
                    </span>
                </td>
