...
<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        <a class="dropdown-item" href="<?= SITE_URL . ($data->language ? \Altum\Language::$active_languages[$data->language] . '/' : null) . 'pages/' . $data->url ?>" target="_blank" rel="noreferrer"><i class="fa fa-fw fa-sm fa-eye mr-2"></i> <?= l('global.view') ?></a>
