...
<div class="dropdown">
    ...
    <div class="dropdown-menu dropdown-menu-right">
        ...
        <?php if(is_numeric($data->id)): ?>
            <a href="#" data-toggle="modal" data-target="#plan_duplicate_modal" data-plan-id="<?= $data->id ?>" class="dropdown-item"><i class="fa fa-fw fa-sm fa-copy mr-2"></i> <?= l('global.duplicate') ?></a>
